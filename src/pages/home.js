...
const generos = [
    "Rock", "Pop", "Eletrônica", "Trap", "Rap", "Funk", "Samba", "Reggae",
    "Jazz", "Blues", "Forró", "MPB", "Clássica", "Lo-fi", "Metal", "House"
];

const efeitos = [
    "Animado", "Dramático", "Épico", "Triste",
    "Futurista", "Sombrio", "Minimalista"
];
...
const instrumentosPorGenero = {
    ...
    Reggae: ["Guitarra Delay", "Baixo Marcante", "Bateria One Drop", "Órgão Hammond"],
    ...
    Metal: ["Guitarra Distortion", "Duplo Pedal", "Baixo Pesado", "Guitarra Solo"],
...
function Home() {
    ...
    function gerarPrompt() {
        const prompt = `
Crie uma música no gênero ${genero},
utilizando os instrumentos: ${instrumentos.join(", ")},
com o clima: ${efeitosSelecionados.join(", ")}.
A música deve seguir as características tradicionais do gênero e manter coerência emocional.
`.trim();
            ...
            <section className={styles.cardFiltros}>
                ...
                <div className={styles.filtroItem}>
                    ...
                    <div className={styles.checkboxGroup}>
                        {efeitos.map((ef) => (
                            <label key={ef} className={styles.checkboxItem}>
                                <input
                                    type="checkbox"
                ...
                <div className={styles.filtroItem}>
                    ...
                    <div className={styles.addInstrumento}>
                        ...
                        />
                        <button className={styles.btnAdicionar} onClick={adicionarInstrumento}>
                            Adicionar
                        </button>
                    </div>
                </div>
